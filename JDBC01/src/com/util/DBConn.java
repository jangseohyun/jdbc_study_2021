...
/*
※ 싱글톤(Singleton) 디자인 패턴을 이요한 Database 연결 객체 생성 전용 클래스
...
{
	// 변수 선언
	private static Connection dbConn;	//-- 자동 null 초기화
	...
	public static Connection getConnection()
	{
		...
		if (dbConn == null)
		{
			try
			{
				...
				//-- 『211.238.142.170』는 오라클 서버 ip 주소를 기재하는 부분
				//    원격자의 오라클이 아니라 로컬의 오라클 서버일 경우에는
				//    『localhost』나 『127.0.0.1』 과 같이 loop back address로 기재 가능
			...
			} catch (Exception e)	//-- ClassNotFoundException, SQLExecption
			{
